...
data_formats = ['jpeg', 'jpg', 'png', 'bmp', 'gif']
...
index_name: str = "image-session-index"
...
# Configuracion del cliente de Vision Artificial de Azure
